...
class MCC_rtsGroup_FT
{
	...
	unitsWest[] = {"CUP_B_US_Soldier_TL","CUP_B_US_Soldier_AR","CUP_B_US_Soldier_AAR","CUP_B_US_Soldier_LAT"};
...
class MCC_rtsGroup_MG
{
	...
	unitsWest[] = {"CUP_B_US_Soldier_MG","CUP_B_US_Soldier_AMG"};
...
class MCC_rtsGroup_AT
{
	...
	unitsWest[] = {"CUP_B_US_Soldier_HAT","CUP_B_US_Soldier_AHAT"};
...
class MCC_rtsGroup_AA
{
	...
	unitsWest[] = {"CUP_B_US_Soldier_AA","CUP_B_US_Soldier_AA"};
...
class MCC_rtsGroup_platoon
{
	...
	unitsWest[] = {"CUP_B_US_Soldier_SL","CUP_B_US_Soldier_AR","CUP_B_US_Soldier_AT","CUP_B_US_Soldier","CUP_B_US_Soldier","CUP_B_US_Soldier_Marksman","CUP_B_US_Medic"};
...
class MCC_rtsGroup_sniper
{
	...
	unitsWest[] = {"CUP_B_US_Sniper_M107","CUP_B_US_Spotter"};
