class marksman : rifleman
{
	...
	class west : west
	{
		...
		uniforms[]= {{0,"U_B_CombatUniform_mcam"},{8,"U_B_CombatUniform_mcam_tshirt"},{15,"U_B_T_FullGhillie_tna_F"}};
	};
	...
	class east : east
	{
		...
		uniforms[]= {{0,"U_O_CombatUniform_ocamo"},{8,"U_O_CombatUniform_oucamo"},{15,"U_O_T_FullGhillie_tna_F"}};
	};
