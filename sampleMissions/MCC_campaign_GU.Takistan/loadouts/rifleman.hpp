	...
	class west
	{
		class primary
		{
			...
			class CUP_arifle_Mk17_CQC_EGLM
			{
				...
				magazines[]= {"CUP_20Rnd_762x51_B_SCAR",9,"CUP_20Rnd_TE1_Red_Tracer_762x51_SCAR",2};
		...
		headgear[]= {{0,"CUP_H_USMC_HelmetWDL"},{12,"CUP_H_USArmy_Helmet_ECH1_Sand"},{18,"CUP_H_USArmy_Helmet_Pro"}};
		googles[]= {{0,""},{0,"G_Combat"},{7,"CUP_TK_NeckScarf"},{9,"G_Balaclava_blk"},{11,"G_Tactical_Black"},{13,"G_Sport_Blackred"}};
		vests[]= {{0,"CUP_V_B_MTV_Patrol"},{9,"CUP_V_B_IOTV_Rifleman"},{13,"CUP_V_B_Interceptor_Rifleman"},{19,"V_PlateCarrier1_blk"}};
		backpacks[]= {{0,"CUP_B_USMC_MOLLE"},{7,"CUP_B_USPack_Coyote"},{14,"CUP_B_USPack_Black"},{18,"B_AssaultPack_blk"}};
		uniforms[]= {{0,"CUP_U_B_FR_DirAction2"},{8,"CUP_U_B_USArmy_UBACS"},{15,"CUP_U_B_FR_SpecOps"}};
