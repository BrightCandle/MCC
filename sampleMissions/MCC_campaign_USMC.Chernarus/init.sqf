...
if (isServer || isDedicated) then {
	0 spawn {
		...
		_sidePlayer = west;
		_factionPlayer = "CUP_B_USMC";	//CUP_O_ChDKZ	OPF_F	OPF_T_F		CUP_O_RU	CUP_O_SLA	CUP_O_TK
		_sideEnemy = east;
		_factionEnemy = "CUP_O_ChDKZ";	//CUP_B_GB  CUP_B_US_Army   CUP_B_USMC	BLU_F	BLU_T_F
		_factionCiv = "CIV_F";
