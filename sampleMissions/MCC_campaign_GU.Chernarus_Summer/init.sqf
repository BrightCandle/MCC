...
if (isServer || isDedicated) then {
	0 spawn {
		...
		_sidePlayer = resistance;
		_factionPlayer = "CUP_O_RU";	//CUP_O_ChDKZ	OPF_F	OPF_T_F		CUP_O_RU	CUP_O_SLA	CUP_O_TK
		_sideEnemy = west;
		_factionEnemy = "CUP_B_USMC";	//CUP_B_GB  CUP_B_US_Army   CUP_B_USMC	BLU_F	BLU_T_F
		_factionCiv = "CIV_F";
