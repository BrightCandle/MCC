...
if (isNil "vas_onRespawn") then {vas_onRespawn = true};
...
if (isNil "vas_customslots") then {vas_customslots = 14}; //14 is actually 15 slots, starts from 0 to whatever you set, so always remember when setting a number to minus by 1, i.e 12 will be 11.
