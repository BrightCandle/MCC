...
//=====================================================================================================================================================================
//MCC
["MCC", "openMCC", ["Open MCC", "Open MCC main console"], {if ((player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[nil,nil,nil,nil,0] execVM format ["%1mcc\dialogs\mcc_PopupMenu.sqf",MCC_path];true}}, {}, [211, [false,true,false]],false] call cba_fnc_addKeybind;

//Commander console
["MCC", "commanderConsole", ["Commander Console", "Player must be its side's commander"], {if ((player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[nil,nil,nil,nil,1] execVM format ["%1mcc\dialogs\mcc_PopupMenu.sqf",MCC_path];true}}, {}, [207, [false,true,false]],false] call cba_fnc_addKeybind;

//T2T
["MCC", "t2t", ["Teleport to Team", ""], {if ((player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[objNull] execVM format["%1mcc\general_scripts\mcc_SpawnToPosition.sqf",MCC_path];true}}, {}, [20, [false,false,true]],false] call cba_fnc_addKeybind;

//Squad dialog
["MCC", "squadDialog", ["Squad Management", ""], {if ((player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[nil,nil,nil,nil,2] execVM format ["%1mcc\dialogs\mcc_PopupMenu.sqf",MCC_path];true}}, {}, [25, [false,false,false]],false] call cba_fnc_addKeybind;

//SQL PDA
["MCC", "sqlPDA", ["Squad Leader PDA", "Player must be team leader"], {if ((player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[nil,nil,nil,nil,3] execVM format ["%1mcc\dialogs\mcc_PopupMenu.sqf",MCC_path];true}}, {}, [209, [false,true,false]],false] call cba_fnc_addKeybind;
...
//Self Interaction
["MCC", "selfInteraction", ["Interaction Self", ""], {if ((player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[player] spawn MCC_fnc_interactSelf;true}}, {}, [219, [false,true,false]],false] call cba_fnc_addKeybind;
