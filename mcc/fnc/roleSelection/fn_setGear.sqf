...
if (_select == 1) then {[4] execVM MCC_path+"configs\dialogs\switchDialog.sqf"};			//open weapon menu
if (_select == 2) then {[5] execVM MCC_path+"configs\dialogs\switchDialog.sqf"};			//open uniform menu
