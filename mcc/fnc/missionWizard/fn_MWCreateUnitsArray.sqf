				...
				if (toUpper(_cfgFaction) == toUpper _faction) then
				{
					if (_vehicleclass in ["Men","MenDiver","MenRecon","MenSniper","MenSupport","MenStory","Car","Armored","Air","Autonomous","Support","Ship","Submarine","Static"]) then
					{
						switch (toLower(_vehicleclass)) do
						{
							case "men"		: 	{
													_type="LAND";
													MCC_MWunitsArrayMen set[count MCC_MWunitsArrayMen,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "mendiver"	: 	{
													_type="WATER";
													MCC_MWunitsArrayMenDiver set[count MCC_MWunitsArrayMenDiver,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "menrecon"	: 	{
													_type="LAND";
													MCC_MWunitsArrayMenRecon set[count MCC_MWunitsArrayMenRecon,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "mensniper": 	{
													_type="LAND";
													MCC_MWunitsArrayMenSniper set[count MCC_MWunitsArrayMenSniper,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "mensupport": 	{
													_type="LAND";
													MCC_MWunitsArrayMenSupport set[count MCC_MWunitsArrayMenSupport,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "car"		: 	{
													_type="LAND";
													MCC_MWunitsArrayCar set[count MCC_MWunitsArrayCar,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "armored"	: 	{
													_type="LAND";
													MCC_MWunitsArrayArmored set[count MCC_MWunitsArrayArmored,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "support"		: 	{
													_type="LAND";
													MCC_MWunitsArraySupport set[count MCC_MWunitsArraySupport,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};
							...
							case "ship"		: 	{
													_type="WATER";
													MCC_MWunitsArrayShip set[count MCC_MWunitsArrayShip,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "submarine"	: 	{
													_type="WATER";
													MCC_MWunitsArraySubmarine set[count MCC_MWunitsArraySubmarine,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};

							case "static"	: 	{
													_type="LAND";
													MCC_MWunitsArrayStatic set[count MCC_MWunitsArrayStatic,[_type,_cfgclass,_side,_vehicleDisplayName]];
												};
					...
					else
					{
						switch (toLower(_simulation)) do
						{
							...
							{
								_type="AIR";
								MCC_MWunitsArrayAir set[count MCC_MWunitsArrayAir,[_type,_cfgclass,_side,_vehicleDisplayName]];
							};
							case "helicopterx":
							{
								_type="AIR";
