...
private ["_params","_ctrl","_button","_posX","_posY","_shift","_ctrlKey","_alt","_class","_html","_comboBox","_displayname","_index","_pic"];
...
if (_button == 0)  then 							
{
	...
	} foreach [["enemy","Spot Enemy","\a3\Ui_F_Curator\Data\CfgMarkers\kia_ca.paa"],["support","Call Support",format["%1data\ammo_icon.paa",MCC_path]],["build","Construct","\A3\ui_f\data\map\markers\handdrawn\pickup_CA.paa"]];
